...
const DOCS = [
  ...
  { id:"idProof",    name:"Passport / ID Proof",      note:"PAN Card / Ration Card",              icon:"🪪", required:true },
  { id:"photo",      name:"Passport Photo",           note:"All applicants & co-applicants",      icon:"🖼️", required:true },
  { id:"income",     name:"Form 16 / Salary Slips",   note:"Latest, or 2 years ITR for business", icon:"💼", required:true },
  { id:"bank",       name:"Bank Statement",           note:"Last 6 months — main account",        icon:"🏦", required:true },
  { id:"entity",     name:"Business Registration",    note:"MOA/AOA / Partnership Deed, if any",  icon:"🏢", required:false },
  { id:"property",   name:"Property Documents",       note:"Title deed / sale agreement",         icon:"🏬", required:true },
];

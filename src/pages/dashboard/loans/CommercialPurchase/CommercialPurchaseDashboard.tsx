...
const CommercialPurchaseDashboard = () => {
  ...
  const handleApplicationSubmit = (id: string, app: CommercialPurchaseApplication) => {
      ...
      >
        ...
        <div className="px-5 py-5 border-b" style={{ borderColor:"rgba(255,255,255,0.08)" }}>
          <div className="flex items-center gap-3 cursor-pointer group" onClick={() => navigate("/")}>
            ...
            <div>
              <p className="font-extrabold text-white text-sm leading-tight">Commercial Purchase</p>
        ...
        <div className="px-5 py-4 border-t space-y-2" style={{ borderColor:"rgba(255,255,255,0.08)" }}>
          {[["Max Amount","₹15 Crores"],["Rate","From 9.5%"],["Tenure","Up to 15 yrs"]].map(([l,v]) => (

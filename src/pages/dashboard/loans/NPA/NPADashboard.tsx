...
const TABS: { key: Tab; label: string; icon: string; desc: string }[] = [
  { key: "application", label: "Application Form",   icon: "📝", desc: "Fill your NPA account details" },
...
const NPADashboard = () => {
  ...
  const handleApplicationSubmit = (id: string, app: NPAApplication) => {
      ...
      >
        ...
        <div className="px-5 py-5 border-b" style={{ borderColor:"rgba(255,255,255,0.08)" }}>
          <div className="flex items-center gap-3 cursor-pointer group" onClick={() => navigate("/")}>
            ...
            <div>
              <p className="font-extrabold text-white text-sm leading-tight">NPA Resolution</p>
        ...
        <div className="px-5 py-4 border-t space-y-2" style={{ borderColor:"rgba(255,255,255,0.08)" }}>
          {[["Max Amount","₹5 Crores"],["Support","Dedicated RM"],["Timeline","Within 30 days"]].map(([l,v]) => (

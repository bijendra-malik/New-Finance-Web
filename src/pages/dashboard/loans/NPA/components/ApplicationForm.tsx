...
const ApplicationForm = ({userName="",userEmail="",onSubmit}:ApplicationFormProps) => {
  ...
  useEffect(() => {
    let cancelled = false;
    getEmploymentTypesFor("npa", "npaEmploymentTypes")
  ...
  const employmentTypeOptions = useMemo(
    () => (employmentTypesState.length > 0 ? employmentTypesState : [...masters.npaEmploymentTypes]),
    [employmentTypesState, masters.npaEmploymentTypes]
  );
...
const hasExposure = parseInt(form.existingEMI) > 0 || parseInt(form.existingLoanAmount) > 0;
  ...
  const pillBanksSelected = [form.existingBanksNpa, form.existingBanksNonNpa].some(a=>a.length>0);
  const pillLoanTypesSelected = [form.existingLoanTypesNpa, form.existingLoanTypesNonNpa].some(a=>a.length>0);
    ...
    <form className="max-w-4xl mx-auto" onSubmit={handleSubmit} noValidate>
      ...
      <FormCard title="Existing Loan Exposure" subtitle="Fill 0 if you have no other existing loans">
        ...
        <div className="mb-5">
          ...
          {hasExposure&&form.existingBanksNpa.includes(OTHER_OPTION)&&(
        ...
        <div className="mb-5">
          ...
          {hasExposure&&form.existingLoanTypesNpa.includes(OTHER_OPTION)&&(
        ...
        <div className="mb-5">
          ...
          {hasExposure&&form.existingBanksNonNpa.includes(OTHER_OPTION)&&(
        ...
        <div>
          ...
          {hasExposure&&form.existingLoanTypesNonNpa.includes(OTHER_OPTION)&&(

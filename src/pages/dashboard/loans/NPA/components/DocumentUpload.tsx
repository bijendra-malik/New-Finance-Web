...
const DOCS = [
  { id:"pan",         name:"PAN Card",              note:"Applicant PAN card",              icon:"💳", required:true },
  { id:"aadhaar",     name:"Aadhaar Card",          note:"Identity & address proof",         icon:"🪪", required:true },
  { id:"loanAccount", name:"Loan Account Statement",note:"Statement of the NPA-tagged account", icon:"📋", required:true },
  { id:"titleDeed",   name:"Title Deed",            note:"Ownership proof of collateral property", icon:"🏡", required:true },
  { id:"propertyDocs",name:"Property Documents",    note:"Chain of documents, encumbrance certificate", icon:"📜", required:true },
  { id:"bank",        name:"Bank Statement",        note:"Last 6 months",                    icon:"🏦", required:true },
  { id:"itr",         name:"ITR / Salary Slips",    note:"Last 2 years / last 3 months",     icon:"📑", required:true },

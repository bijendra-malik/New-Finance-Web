...
const DOCS = [
  ...
  { id:"saleDeed",    name:"Sale Agreement",        note:"Agreement to sell / sale deed",    icon:"🏡", required:true },
  { id:"propertyDocs",name:"Property Documents",    note:"Title deed, chain of documents",   icon:"📜", required:true },

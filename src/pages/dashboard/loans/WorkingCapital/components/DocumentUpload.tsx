...
const DOCS = [
  { id:"kyc",     name:"KYC Documents",             note:"Self-attested copies",              icon:"🪪", required:true },
  { id:"entity",  name:"Entity Proof",               note:"Partnership deed / Incorporation",  icon:"🏢", required:true },
  { id:"pan",     name:"PAN Card",                   note:"Entity & proprietors / partners",   icon:"💳", required:true },
  { id:"financials", name:"Audited Financials",      note:"Last 3 years — Balance Sheet, P&L", icon:"📑", required:true },
  { id:"itr",     name:"Income Tax Returns",         note:"Last 1 year, with computation",     icon:"🧾", required:true },
  { id:"bank",    name:"Bank Statement",              note:"Last 6-12 months",                  icon:"🏦", required:true },
  { id:"projectReport", name:"Project Report",        note:"Cost, means of finance, projections", icon:"📊", required:false },

...
const TABS: { key: Tab; label: string; icon: string; desc: string }[] = [
  { key: "application", label: "Application Form",   icon: "📝", desc: "Fill your funding details"  },
...
const FilmLoanDashboard = () => {
  ...
  const handleApplicationSubmit = (id: string, app: FilmLoanApplication) => {
      ...
      >
        ...
        <div className="px-5 py-5 border-b" style={{ borderColor:"rgba(255,255,255,0.08)" }}>
          <div className="flex items-center gap-3 cursor-pointer group" onClick={() => navigate("/")}>
            ...
            <div>
              <p className="font-extrabold text-white text-sm leading-tight">Film Funding</p>

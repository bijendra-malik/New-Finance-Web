...
const ApplicationForm = ({userName="",userEmail="",onSubmit}:ApplicationFormProps) => {
  ...
  const [submittedApp, setSubmittedApp] = useState<FilmLoanApplication|null>(null);
    ...
    <SubmissionSuccess
      ...
      sections={buildSuccessSections(submittedApp, {
        productSection: {
          title: "Film Details",
          rows: [
            { label: "Film Category", value: submittedApp.filmComesUnder },
            { label: "Languages", value: submittedApp.filmLanguages?.length ? submittedApp.filmLanguages.join(", ") : undefined },
            { label: "Star Cast", value: submittedApp.starCastNames?.length ? submittedApp.starCastNames.join(", ") : undefined },
            ...
            { label: "Own Investment", value: submittedApp.ownInvestmentAmount ? `₹${submittedApp.ownInvestmentAmount.toLocaleString("en-IN")}` : undefined },
          ],
        },
      })}
    />
  ...
  return (
    <form className="max-w-4xl mx-auto" onSubmit={handleSubmit} noValidate>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          {form.employmentType===SELF_EMPLOYED_BUSINESS&&(<>
            ...
            <div id="businessName"><FieldLabel label="Film Production Company Name" required/>
              <TextField value={form.businessName} onChange={v=>set("businessName",v)} placeholder="Full Name" err={errors.businessName}/>
            </div>
          ...
          {(form.employmentType===SELF_EMPLOYED_BUSINESS||form.employmentType===SELF_EMPLOYED_PROFESSIONAL)&&(<>
            <div id="businessState"><FieldLabel label="Current Company State" required/>
            ...
            <div id="businessCity"><FieldLabel label="Current Company City" required/>
            ...
            <PincodeInputField
              id="businessPincode" label="Current Company Pincode"
              value={form.businessPincode} onChange={v=>set("businessPincode",v)} err={errors.businessPincode}
            />
            <SelectWithOther
              id="businessPlaceStatus" label="Status Of Company Place" required
              ...
              otherId="businessPlaceStatusOther" otherLabel="Mention Status Of Company Place"
              otherValue={form.businessPlaceStatusOther} onOtherChange={v=>set("businessPlaceStatusOther",v)}
              otherPlaceholder="Enter status of company place" otherErr={errors.businessPlaceStatusOther}
            />
          </>)}
        </div>
      </FormCard>
      ...
      <FormCard title="Personal Details" subtitle="Basic details as per your official documents">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div id="fullName"><FieldLabel label="Director's Full Name" required/>
            <TextField value={form.fullName} onChange={v=>set("fullName",v)} placeholder="As per PAN Card" err={errors.fullName}/>
          </div>
          <div id="mobile"><FieldLabel label="Director's Mobile Number" required/>
          ...
          <div id="email"><FieldLabel label="Director's Email Address" required/>

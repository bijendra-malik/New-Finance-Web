...
const DOCS = [
  { id:"pan",     name:"PAN Card",              note:"Business or applicant PAN",      icon:"💳", required:true },
  { id:"gst",     name:"GST Certificate",       note:"GST registration certificate",   icon:"🧾", required:true },
  { id:"regProof",name:"Business Registration", note:"Incorporation / registration",   icon:"🏢", required:true },
  { id:"bank",    name:"Bank Statement",        note:"Last 12 months — business a/c",  icon:"🏦", required:true },
  { id:"itr",     name:"ITR / Financials",      note:"Last 2 years",                   icon:"📑", required:true },
  { id:"address", name:"Address Proof",         note:"Business address proof",         icon:"📬", required:true },

...
const TABS: { key: Tab; label: string; icon: string; desc: string }[] = [
  { key: "application", label: "Application Form",   icon: "📝", desc: "Fill your limit details"    },
...
const ODCCLimitDashboard = () => {
  ...
  const handleApplicationSubmit = (id: string, app: ODCCLimitApplication) => {
      ...
      >
        ...
        <div className="px-5 py-5 border-b" style={{ borderColor:"rgba(255,255,255,0.08)" }}>
          <div className="flex items-center gap-3 cursor-pointer group" onClick={() => navigate("/")}>
            ...
            <div>
              <p className="font-extrabold text-white text-sm leading-tight">OD / CC Limit</p>
        ...
        <div className="px-5 py-4 border-t space-y-2" style={{ borderColor:"rgba(255,255,255,0.08)" }}>
          {[["Max Limit","₹5 Crores"],["Rate","From 10.5%"],["Renewal","Up to 5 yrs"]].map(([l,v]) => (

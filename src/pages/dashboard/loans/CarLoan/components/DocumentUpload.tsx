...
const DOCS = [
  ...
  { id:"passport",name:"Passport / ID Proof", note:"Aadhaar / Passport / Voter ID", icon:"🪪", required:true },
  { id:"photo",   name:"Passport Photo",   note:"Recent, white background",      icon:"🖼️", required:true },
  { id:"utility", name:"Utility Bill",     note:"Office & residence, latest month", icon:"📬", required:true },
  { id:"salary",  name:"Salary Slip / Form 16", note:"Last 6 months / last 2 years", icon:"💼", required:true },
  { id:"bank",    name:"Bank Statement",   note:"Last 6 months — salary a/c",    icon:"🏦", required:true },
];

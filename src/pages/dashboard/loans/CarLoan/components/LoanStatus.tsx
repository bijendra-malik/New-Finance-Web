  ...
  if (!isSubmitted) {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center">
        ...
        <p className="text-sm" style={{color:C.gray}}>Submit your vehicle loan application to track its status here.</p>
      </div>
    );
  }
    ...
    <div className="space-y-6 max-w-3xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          ...
          {/* Vehicle details */}
          <div className="bg-white rounded-2xl p-6 shadow-sm" style={{border:`1px solid ${C.teal}18`}}>
            <p className="text-xs font-bold uppercase tracking-wide mb-4" style={{color:C.teal}}>Vehicle Details</p>
            <div className="space-y-3">
              {[
                ["Vehicle Type",  submittedApp?.vehicleType??"—"],
                ["Transmission",  submittedApp?.transmissionType??"—"],
                ["Manufacturer",  submittedApp?.manufacturer??"—"],
                ["Model",         submittedApp?.model??"—"],
                ["Purchase Type", submittedApp?.vehiclePurchaseType??"—"],
              ].map(([l,v])=>(

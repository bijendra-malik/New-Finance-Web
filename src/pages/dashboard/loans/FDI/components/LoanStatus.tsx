    ...
    <div className="space-y-6 max-w-3xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          ...
          {/* Fund against details */}
          <div className="bg-white rounded-2xl p-6 shadow-sm" style={{border:`1px solid ${C.teal}18`}}>
            <p className="text-xs font-bold uppercase tracking-wide mb-4" style={{color:C.teal}}>Fund Against Details</p>
            <div className="space-y-3">
              {[
                ["Fund Against",   submittedApp?.collateralPropertyType??"—"],
                ...(submittedApp?.collateralPropertyType==="Company Valuation" ? [
                  ["Company Valuation", `₹${(submittedApp?.companyEvaluationValue??0).toLocaleString("en-IN")}`],
                  ["Equity Partner",     submittedApp?.interestedInEquityPartner??"—"],
                  ...(submittedApp?.interestedInEquityPartner==="Yes" ? [
                    ["Equity Share Offered", `${submittedApp?.equityShareOffered??0}%`],
                  ] : []),
                ] : []),

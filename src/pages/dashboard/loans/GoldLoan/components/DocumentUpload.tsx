...
const DOCS = [
  ...
  { id:"titleDeed",   name:"Title Deed",            note:"Ownership proof of collateral",    icon:"🏡", required:true },
  { id:"propertyDocs",name:"Collateral Documents",  note:"Supporting ownership/valuation documents", icon:"📜", required:true },

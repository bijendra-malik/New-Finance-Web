...
const ApplicationForm = ({userName="",userEmail="",onSubmit}:ApplicationFormProps) => {
  ...
  const [submittedApp, setSubmittedApp] = useState<ProjectLoanApplication|null>(null);
  ...
  const handleSubmit = async (e:React.FormEvent) => {
    ...
    const app: ProjectLoanApplication = {
      _id: `PL${Date.now()}`,
      ...
      projectType:form.projectType===OTHER_OPTION?form.projectTypeOther:form.projectType,
        ...
        <div className="p-10 text-center bg-white">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 text-left mb-6">
            {[
              ...
              ["Project Type", submittedApp.projectType||"—"],
              ["Project Cost", `₹${submittedApp.totalProjectCost.toLocaleString("en-IN")}`],
    ...
    <form className="max-w-4xl mx-auto" onSubmit={handleSubmit} noValidate>
      <div className="mb-6">
        <h1 className="text-xl font-bold" style={{color:C.dark}}>
          Unlock the best Project Loan offers suitable for your needs from 43+ lenders
        </h1>
      ...
      <FormCard title="Loan Requirements" subtitle="How much do you need and for how long?">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <TenureYearsField
            ...
            options={masters.projectLoanTenureYears} err={errors.loanTenureYears}
          />
          <SelectWithOther
          ...
          <div id="totalProjectCost"><FieldLabel label="Total Project Cost" required/>
            <TextField type="number" value={form.totalProjectCost} onChange={v=>set("totalProjectCost",v.replace(/\D/g,""))} placeholder="e.g. 10000000" err={errors.totalProjectCost}/>
          </div>
          ...
          <div id="ownInvestment"><FieldLabel label="Own Investment on Project" required/>
            <TextField type="number" value={form.ownInvestment} onChange={v=>set("ownInvestment",v.replace(/\D/g,""))} placeholder="0" err={errors.ownInvestment}/>
          </div>
        </div>
      </FormCard>
            ...
            <div id="gstNumber"><FieldLabel label="GST No (if available)"/>
              ...
              <div id="businessEstablishedDate"><FieldLabel label="Date Of Business Establishment" required/>
                <DateField value={form.businessEstablishedDate} onChange={v=>set("businessEstablishedDate",v)}
                  ...
                  portalId="project-loan-business-established-datepicker-portal"/>
              </div>

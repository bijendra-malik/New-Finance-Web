...
const DOCS = [
  { id:"pan",        name:"PAN Card",                  note:"Company or applicant PAN",        icon:"💳", required:true },
  { id:"gst",        name:"GST Certificate",            note:"GST registration certificate",    icon:"🧾", required:true },
  { id:"regProof",   name:"Company Registration",       note:"MOA & AOA / Partnership Deed",    icon:"🏢", required:true },
  { id:"bank",       name:"Bank Statement",             note:"Last 6 months — current account", icon:"🏦", required:true },
  { id:"itr",        name:"ITR / Financials",           note:"Last 2 years, audited/CA-certified", icon:"📑", required:true },
  { id:"projectPlan",name:"Project Plan Presentation",  note:"PPT / Excel presentation",         icon:"📊", required:true },
  { id:"property",   name:"Property & Title Documents", note:"Approved plan, registry chain",    icon:"🏠", required:true },
  { id:"photo",      name:"Passport Photo",             note:"Recent, white background",         icon:"🖼️", required:true },
];

  ...
  if (!isSubmitted) {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center">
        ...
        <p className="text-sm" style={{color:C.gray}}>Submit your project loan application to track its status here.</p>
      </div>
    );
  }
    ...
    <div className="space-y-6 max-w-3xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm" style={{border:`1px solid ${C.navy}18`}}>
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                ["Project Cost",  `₹${(submittedApp?.totalProjectCost??0).toLocaleString("en-IN")}`],
              ].map(([l,v])=>(
          ...
          {/* Project timeline */}
          <div className="bg-white rounded-2xl p-6 shadow-sm" style={{border:`1px solid ${C.teal}18`}}>
            <p className="text-xs font-bold uppercase tracking-wide mb-4" style={{color:C.teal}}>Project Timeline</p>
            <div className="space-y-3">
              {[
                ["Start Date",      submittedApp?.projectStartDate?new Date(submittedApp.projectStartDate).toLocaleDateString("en-IN",{day:"numeric",month:"short",year:"numeric"}):"—"],
                ["Completion Date", submittedApp?.projectCompletionDate?new Date(submittedApp.projectCompletionDate).toLocaleDateString("en-IN",{day:"numeric",month:"short",year:"numeric"}):"—"],
                ["Own Investment",  `₹${(submittedApp?.ownInvestment??0).toLocaleString("en-IN")}`],
              ].map(([l,v])=>(

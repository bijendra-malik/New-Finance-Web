      ...
      <FormCard title="Income Details" subtitle="Tell us about your employment and income">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div id="employmentType"><FieldLabel label="Employment Type" required/>
            <SelectField value={form.employmentType} onChange={setEmploymentType} options={masters.loanAgainstPropertyEmploymentTypes} placeholder="Select" err={errors.employmentType}/>
          </div>

...
const DOCS = [
  { id:"ageProof",    name:"Age Proof",                     note:"Student — Aadhaar / Birth certificate",  icon:"🪪", required:true },
  { id:"admission",   name:"Admission Letter",               note:"From university / institute",           icon:"🎓", required:true },
  { id:"address",     name:"Address Proof",                  note:"Co-applicant's residence",               icon:"📬", required:true },
  { id:"coIncome",    name:"Co-Applicant Income Proof",      note:"Payslips / Form 16 / ITR",               icon:"💼", required:true },
  { id:"coBank",      name:"Co-Applicant Bank Statement",    note:"Last 6 months",                          icon:"🏦", required:true },
  { id:"photo",       name:"Passport Photo",                 note:"Applicant & co-applicant",               icon:"🖼️", required:true },
];

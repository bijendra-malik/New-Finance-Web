...
const DOCS = [
  { id:"pan",     name:"PAN Card",           note:"Identity & signature proof",     icon:"💳", required:true },
  { id:"idProof", name:"Aadhaar / Voter ID", note:"Identity proof",                 icon:"🪪", required:true },
  ...
  { id:"income",  name:"Income Proof",       note:"Salary slips / ITR",             icon:"💼", required:true },

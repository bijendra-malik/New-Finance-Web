...
const STATUS_STEPS = [
  ...
  { key:"Approved",     icon:"👍", desc:"Card issuer approved"            },
  { key:"Disbursed",    icon:"💳", desc:"Card dispatched to your address" },
];
  ...
  if (!isSubmitted) {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center">
        ...
        <p className="text-sm" style={{color:C.gray}}>Submit your credit card application to track its status here.</p>
      </div>
    );
  }
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm" style={{border:`1px solid ${C.navy}18`}}>
            <p className="text-xs font-bold uppercase tracking-wide mb-4" style={{color:C.navy}}>Card Details</p>
            <div className="grid grid-cols-2 gap-3">
              {[
                ["Preferred Bank", submittedApp?.applyForBank??"—"],
                ["Existing Card",  submittedApp?.hasActiveCard??"—"],

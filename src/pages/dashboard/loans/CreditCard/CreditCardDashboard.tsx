...
const TABS: { key: Tab; label: string; icon: string; desc: string }[] = [
  { key: "application", label: "Application Form",   icon: "📝", desc: "Fill your card details"    },
...
const CreditCardDashboard = () => {
  ...
  const handleApplicationSubmit = (id: string, app: CreditCardApplication) => {
      ...
      >
        ...
        <div className="px-5 py-5 border-b" style={{ borderColor:"rgba(255,255,255,0.08)" }}>
          <div className="flex items-center gap-3 cursor-pointer group" onClick={() => navigate("/")}>
            ...
            <div>
              <p className="font-extrabold text-white text-sm leading-tight">Credit Card</p>
        ...
        <div className="px-5 py-4 border-t space-y-2" style={{ borderColor:"rgba(255,255,255,0.08)" }}>
          {[["Cashback","Up to 5%"],["Annual Fee","₹0 - ₹999"],["Approval","In 48 hrs"]].map(([l,v]) => (

...
const DOCS = [
  { id:"pan",         name:"PAN Card",                note:"Front & back — clear scan",              icon:"💳", required:true },
  { id:"aadhaar",     name:"Aadhaar Card",             note:"Front & back — clear scan",              icon:"🪪", required:true },
  { id:"bank",        name:"Bank Statement",           note:"Last 12 months",                         icon:"🏦", required:true },
  { id:"foreclosure", name:"Foreclosure Letter",       note:"From existing bank, if available",       icon:"📃", required:true },
  { id:"property",    name:"Property Documents",       note:"Only if the loan is secured",             icon:"🏠", required:false },
  { id:"photo",       name:"Passport Photo",           note:"Recent, white background",               icon:"🖼️", required:true },
  { id:"address",     name:"Address Proof",            note:"Utility bill / rent agreement",           icon:"📬", required:true },
];

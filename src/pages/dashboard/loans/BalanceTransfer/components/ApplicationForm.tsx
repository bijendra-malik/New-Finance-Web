...
const ApplicationForm = ({userName="",userEmail="",onSubmit}:ApplicationFormProps) => {
  ...
  const employmentBranchFields: (keyof FormData)[] = [
    ...
    "businessState", "businessCity", "businessPincode", "businessPincodeOther", "businessPlaceStatus", "businessPlaceStatusOther",
  ];
      ...
      <div className="rounded-3xl overflow-hidden shadow-xl" style={{border:`1px solid ${C.teal}33`}}>
        ...
        <div className="p-10 text-center bg-white">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 text-left mb-6">
            {[
              ["Transfer Amount", `₹${submittedApp.loanAmount.toLocaleString("en-IN")}`],
              ["Tenure",          `${submittedApp.loanTenure} months`],
              ["Transfer Type",   submittedApp.balanceTransferType||"—"],
              ["City",            submittedApp.city],
              ["State",           submittedApp.state],

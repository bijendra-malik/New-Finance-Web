...
const DOCS = [
  ...
  { id:"pan",     name:"PAN Card",                   note:"Self-attested copy",                 icon:"💳", required:true },
  { id:"demat",   name:"DEMAT Account Statement",     note:"Latest holding / transaction statement", icon:"📈", required:true },
  { id:"cml",     name:"Client Master List (CML)",    note:"Or DP statement, not older than 1 month", icon:"📄", required:true },
  { id:"bank",    name:"Bank Statement",              note:"Last 6 months",                      icon:"🏦", required:true },
  { id:"itr",     name:"Income Tax Returns",          note:"Last 1 year, with computation",      icon:"🧾", required:false },
  { id:"pledge",  name:"Pledge Request Form",         note:"Duly signed",                        icon:"✍️", required:true },

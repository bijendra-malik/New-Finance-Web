...
const LoanAgainstShareDashboard = () => {
  ...
  const handleApplicationSubmit = (id: string, app: LoanAgainstShareApplication) => {
      ...
      >
        ...
        <div className="px-5 py-5 border-b" style={{ borderColor:"rgba(255,255,255,0.08)" }}>
          <div className="flex items-center gap-3 cursor-pointer group" onClick={() => navigate("/")}>
            ...
            <div>
              <p className="font-extrabold text-white text-sm leading-tight">Loan Against Share</p>
        ...
        <div className="px-5 py-4 border-t space-y-2" style={{ borderColor:"rgba(255,255,255,0.08)" }}>
          {[["Max Amount","₹5 Crores"],["Rate","From 10.5%"],["Tenure","Up to 7 yrs"]].map(([l,v]) => (

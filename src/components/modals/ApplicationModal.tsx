      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
        <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div
            ...
            style={{ background: "linear-gradient(135deg, var(--brand-blue) 0%, var(--brand-blue-dark) 100%)" }}
          >
            <button
              onClick={handleClose}
              disabled={isBusy}
            ...
            {/* Product name */}
            <p className="text-(--brand-blue-200) text-xs font-semibold uppercase tracking-wider mb-1">
              {productName}
            </p>
            ...
            <p className="text-sm text-(--brand-blue-tint) mt-0.5">
              {step === "details"
                ? mode === "signup"
              ...
              {[
                ...
                return (
                  <div key={label} className="flex items-center gap-2">
                    <div className={`w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold transition-all ${done ? "bg-green-400 text-white" : active ? "bg-white text-(--brand-blue)" : "bg-white/20 text-white/50"}`}>
                      {done ? "✓" : i + 1}
                    </div>
            ...
            {step === "details" && mode === "signup" && (
              <form onSubmit={handleSendOtp} className="space-y-4">
                ...
                <p className="text-xs text-slate-400 text-center">
                  ...
                  <button type="button" onClick={() => switchMode("signin")} className="text-(--brand-blue) font-semibold hover:underline">
                    Sign In
                  </button>
                </p>
              </form>
            ...
            {step === "details" && mode === "signin" && (
              <form onSubmit={handleSendOtp} className="space-y-4">
                <div className="text-center mb-2">
                  <div className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-(--brand-blue-bg) mb-3">
                    <svg className="w-7 h-7 text-(--brand-blue)" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
                ...
                <p className="text-xs text-slate-400 text-center">
                  New user?{" "}
                  <button type="button" onClick={() => switchMode("signup")} className="text-(--brand-blue) font-semibold hover:underline">
                    Create account
                  </button>
                </p>
              </form>
              ...
              <form onSubmit={handleVerifyOtp} className="space-y-5">
                ...
                <div>
                  ...
                  <input
                    ...
                    maxLength={8}
                    autoFocus
                    className={`w-full px-4 py-3 border rounded-lg text-xl tracking-[0.4em] text-center font-bold focus:outline-none focus:ring-2 focus:ring-(--brand-blue) transition disabled:bg-slate-100 ${otpError ? "border-red-400" : "border-slate-300"}`}
                  />
                ...
                <div className="flex justify-between items-center">
                  ...
                  <button
                    ...
                    className="text-sm text-(--brand-blue) hover:text-blue-800 font-medium disabled:opacity-40 flex items-center gap-1 transition"
                  >
